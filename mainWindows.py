...
class fileIcons():
    ...
    def icon_customize(self, index):
        if index < len(self.files):
            ...
            self.icons[index].setPixmap(QPixmap(f"PresentationFiles/{self.files[index].split(sep='.')[0]}/Слайд1.png"))
...
def CV2(id):
    ...
    while connected:
        img = cv2.imread(r'D:\Projects\GUI\pyProject\Ui\Images\attendance.png')
